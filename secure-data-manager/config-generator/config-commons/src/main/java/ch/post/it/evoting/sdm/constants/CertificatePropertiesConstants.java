 ...
 */
package ch.post.it.evoting.sdm.constants;
...
public class CertificatePropertiesConstants {
	...
	public static final String SIGNING_CERTIFICATE_ALIAS = "signerKey";

	public static final String ENCRYPTION_CERTIFICATE_ALIAS = "encryptionKey";
