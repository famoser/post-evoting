...
/**
 * Decorator of the credential id rule.
 */
@Decorator
public class CredentialIdRuleDecorator implements AbstractRule<Vote> {

	@Inject
	@Delegate
	private CredentialIdRule credentialIdRule;
	...
	public ValidationError execute(Vote vote) {
		return credentialIdRule.execute(vote);
	}
	...
	public String getName() {
		return credentialIdRule.getName();
	}
