 ...
 */
@Entity
@Table(name = "ELECTION_PUBLIC_KEY", uniqueConstraints = {
		@UniqueConstraint(name = "ELECTION_PUBLIC_KEY_UK1", columnNames = { "TENANT_ID", "ELECTION_EVENT_ID", "ELECTORAL_AUTHORITY_ID" }) })
public class ElectionPublicKey {

	/**
	 * The identifier for this election public key and verification set pair.
	 */
	@Id
	...
	/**
	 * The election public key in jwt format.
	 */
	@Lob
	@Column(name = "JWT", length = Integer.MAX_VALUE)
	@NotNull
	private String jwt;
