 ...
 */
@Decorator
public class PlainTextEqualityProofRuleDecorator implements AbstractRule<Vote> {

	@Inject
	@Delegate
	PlainTextEqualityProofRule plainTextEqualityProofRule;
	...
	public ValidationError execute(Vote vote) {
		return plainTextEqualityProofRule.execute(vote);
	}
	...
	public String getName() {
		return plainTextEqualityProofRule.getName();
	}
