...
/**
 * Web service for handling data of the electoral authorities in the election information context (EI).
 */
...
public class ElectoralDataEIResource {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ElectoralDataEIResource.class);
	...
	@Inject
	ElectoralDataEIResource(ElectionInformationAdminClient electionInformationAdminClient, TrackIdGenerator trackIdGenerator) {
