...
public class ElectoralDataEIResourceTest extends JerseyTest {
	...
	private static final String URL_SAVE_EE_CONTEXT_DATA = ElectoralDataEIResource.RESOURCE_PATH + "/" + ElectoralDataEIResource.SAVE_ELECTORAL_DATA;
	@ClassRule
	...
	public void saveElectionEventData() throws IOException {
		...
		when(electionInformationAdminClient
				.saveElectoralData(eq(ElectoralDataEIResource.ELECTORAL_DATA_PATH), eq(TENANT_ID), eq(ELECTION_EVENT_ID), eq(ELECTORAL_AUTHORITY_ID),
	...
	protected Application configure() {
		...
		sut = new ElectoralDataEIResource(electionInformationAdminClient, trackIdGenerator);
