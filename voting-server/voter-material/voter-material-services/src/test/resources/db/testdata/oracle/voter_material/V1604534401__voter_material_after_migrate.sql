Insert into VOTER_MATERIAL.PLATFORM_CERTIFICATE (ID,PLATFORM_NAME,CERTIFICATE_NAME,CERTIFICATE_CONTENT) values (PLATFORM_CERTIFICATE_SEQ.NEXTVAL,'SwissPost','dev Root CA',TO_CLOB(q'[-----BEGIN CERTIFICATE-----
